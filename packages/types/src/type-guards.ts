...
/**
 * Check whether a given value is an {@link @yonet/types#ITeam}
...
/**
 * Check whether a given value is an {@link @yonet/types#IChannel}
 * @param arg - value to check
 * @beta
 */
...
/**
 * Check whether a given value is an {@link @yonet/types#IMessage}
 * @param arg - value to check
 * @beta
 */
